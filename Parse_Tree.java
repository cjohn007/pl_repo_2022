...
public class Parse_Tree {
    ...
    public static String parser(String input) {
        ...
        String[] data_types = { "int", "double", "boolean", "String" };
        String[] operators = { "+", "-", "*", "/" };
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (current.equals(";")) {
            ...
            } else if (isInteger(current, splitted)) {
                if (row[rowcurr + 2].equals("")) {
                    row[rowcurr + 1] += repeat(" ", indent);
                    row[rowcurr + 2] += repeat(" ", indent);
                }
                ...
                rowcurr += 2;
                indent = row[rowcurr].length();
            } else if (isDouble(current, splitted)) {
                if (row[rowcurr + 2].equals("")) {
                    row[rowcurr + 1] += repeat(" ", indent);
                    row[rowcurr + 2] += repeat(" ", indent);
                }
    ...
    public static boolean isInteger(String string, String[] array) {
        int intValue;
        ...
        try {
            if (!(string.contains(".")) && array[0].contentEquals("int")) {
    ...
    public static boolean isDouble(String string, String[] array) {
        double doubleValue;
        if (string == null || string.equals("")) {
            return false;
        }
        ...
        try {
            if (string.contains(".") && array[0].contentEquals("double")) {
